...
**BE Computer Engineering (AI/ML Honors) | CGPA: 9.778**
...
**Full-Stack Versatility:** From embedded C to modern web frameworks with strong DSA foundation

**Modern Practices:** AI-assisted development, Git workflows, continuous learning mindset

**Proven Track Record:** Successful internship, multiple hackathon wins, strong academic performance (9.778 CGPA)

---

## 📫 Open to Opportunities

Actively seeking **full-time roles** and **internships** in:
